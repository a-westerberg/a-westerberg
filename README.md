...
During my internship I worked on Python backend at a startup, building real features in production. My favorite part of development is taking a new feature from idea to working code.
...
**Stack:** Java 17, Spring Boot 4, PostgreSQL 17, Redis 7, Keycloak 26, React 19, TypeScript, Tailwind, TanStack Query, IGDB API, Docker.
...
**Infrastructure:** CI on GitHub Actions across all five repos via reusable workflows, images published to GHCR.
